...
namespace PTC
{
    public partial class RegistroDeli : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (TextBox3.Text.Trim() != "" && passwordfield.Text.Trim() != "" && confpasswordfield.Text.Trim() != "" && TextBox1.Text.Trim() != "" && TextBox2.Text.Trim() != "" && TextBox5.Text.Trim() != "")
            {
                if (passwordfield.Text == confpasswordfield.Text)
                {
                    ...
                    if (datosdeli.UsuariosRepetidos3(usuario, encriptada, nombre, apellido, correo) == 0)
                    {
        ...
        {
            Response.Redirect("RegisterDeling.aspx");
        }
    }
}