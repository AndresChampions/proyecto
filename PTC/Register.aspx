<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="PTC.Register" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="style2">
            ...
            <br />
              ...
              <asp:TextBox ID="passwordfield" runat="server" type ="password" name="contra" placeholder="Write your password" Width="171px"></asp:TextBox>
             <br />
              <br />
  
              <asp:Label ID="Label6" runat="server" Text="Confirm your password"></asp:Label><br /> <br />
              <asp:TextBox ID="confpasswordfield" type="password" name="contra" runat="server" placeholder="Write again your password" Width="170px"></asp:TextBox><br />
