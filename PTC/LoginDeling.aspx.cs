...
namespace PTC
{
    public partial class LoginDeling : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (TextBox2.Text != "" && TextBox1.Text != "")//Validando espacio vacio
            {
                ...
                var cmd = "SELECT Id_usuario from usuariosdeli WHERE Nombre_Usuario='" + usuario + "' AND Password='" + contra + "';";
                ...
                if (retorno != 0)
                {
                    ...
                    Response.Redirect("003-MainPage.aspx");//Nos redirecciona a nuestro formulario
                }
                else
                {
